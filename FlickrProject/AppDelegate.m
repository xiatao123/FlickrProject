...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MovieViewController *topRatedViewController = (MovieViewController *)[topRatedNavigationController topViewController];
    ...
    MovieViewController *nowPlayingController = (MovieViewController *)[nowPlayingNavigationController topViewController];
